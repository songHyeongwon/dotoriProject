...
<script type="text/javascript">
	...
	function addItem(cs_r_num, cs_r_name, cs_r_content, r_date) {//새로운 댓글 객체 추가		
	...
	function listAll(cs_num) {
		...
		$.getJSON(url, function(data) {
			...
			$(data).each(function() {
				...
				addItem(cs_r_num,cs_r_name,cs_r_content,r_date);
			})
		}).fail(function() {
					...
					<div class="modal-body">
						<form id="replyForm" name="replyForm">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" id="r_pwd" name="r_pwd" />
							</div>
						</form>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="updateForm" name="updateForm">
							...
							<div class="form-group">
								<label for="message-text" class="control-label">글내용: </label>
								<textarea class="form-control" id="cs_r_content2" name="cs_r_content1"
									rows="5"></textarea>
							</div>
						</form>
					</div>

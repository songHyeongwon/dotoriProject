	...
	<body>
		...
		<c:choose>
			<c:when test="${not empty data}">
				<p>
					<button type="button" class="btn btn-primary" id="replyInsertFormBtn">문의하기</button>
				</p>
			</c:when>
		</c:choose>
		<%--리스트 영역 --%>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="replyMadalLabel">문의하기 등록</h4>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="replyMadalLabel">문의글 수정</h4>
					</div>
					<div class="modal-body">

...
public class MemberMVO extends CommonVO{
	...
	private String member_addDate;		// 회원 등록일
	private String member_mPwdDate;		// 회원 비밀번호 변경일
	...
	private Date member_addDate2;		// 회원 등록일
	private Date member_mPwdDate2;		// 회원 비밀번호 변경일
}
